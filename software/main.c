/*
 ...
 Timer1 generates PWM thats used for the carrier frquenz 36KHz
 Timer0 used to count length of of Output IR Modulator
...
#include <stdint.h>
 ...
 volatile uint16_t captureLow	= 0;  
 volatile uint16_t captureHigh	= 0;
 volatile uint16_t countOld		= 0;
